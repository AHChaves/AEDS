...
class PokemonQ5{
    ...
    public PokemonQ5(int id, int generation, String name, String description, List<String> type, List<String> abilities, double weight, double height, int captureRate, boolean isLegendary, LocalDate captureDate){
        this.id = id;
    ...
    public static void main(String[] args) {
        ...
        while(!isFim){
            ...
            if(!isFim){
                ...
                // PokemonQ5 jogadorEncontrado = buscarPorId(listaPokemon, id);
